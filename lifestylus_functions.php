...
// require_once( 'lib/admin-filter.php' );
require_once( 'lib/attachments.php' );
// require_once( 'lib/authors.php' );
// require_once( 'lib/comments.php' );
// require_once( 'lib/cta.php' );
require_once( 'lib/excerpts.php' );
require_once( 'lib/gallery.php' );
// require_once( 'lib/GT_Breadcrumbs2.php' );
...
add_filter( 'get_the_excerpt', 'excerpt_read_more_ellipsis' );
...
add_filter( 'the_excerpt', 'prepend_post_thumbnail', 1 );
...
remove_action( 'wp_head', 'ascetica_style_settings' );
remove_action( 'widgets_init', 'ascetica_unregister_sidebar' );
?>